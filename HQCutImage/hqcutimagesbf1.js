...
(function(W,D) {
	...
	a.rootImg = function(pic) {
		var HQ_cut_view = document.createElement('div');
		HQ_cut_view.className = "HQ_cut_view";
		HQ_cut_view.innerHTML = a.dom;
		//document.body.appendChild(HQ_cut_view);
		document.body.insertBefore(HQ_cut_view,document.body.childNodes[0]);
		
		a.tools.$(".HQ_resize_image").src = a.image;

		a.tools.$(".HQ_cancel_button").addEventListener("click",function() {
			document.body.removeChild(HQ_cut_view);
		},false);
		
		a.tools.$(".HQ_send_button").addEventListener("click",function() {
			a.cutRun();
		},false);
		...
		if(exif==6||exif==8) {
			a.picW = pic.height;
			a.picH = pic.width;
			if(a.picW > a.opt.size && a.picH > a.opt.size&&a.picW <= a.picH) {
				a.picW = a.opt.size;
				a.picH = a.opt.size * a.p;
			}
		}else {
			a.picW = pic.width;
			a.picH = pic.height;
			if(a.picH > a.opt.size && a.picW > a.opt.size) {
				a.picH = a.opt.size;
				a.picW = a.opt.size * a.p;
			}
		}
		if(a.ua=="ios") a.resize(a.picW,a.picH,true);
		else {
			setTimeout(function() {
				a.resize(a.picW,a.picH,true);
			},10);
		}
	};
	
	a.resize = function(width,height,t) {
        ...
        o.src = a.c.toDataURL("image/jpeg");
		if(t) {
			a.oW = a.picW;
			a.oH = a.picH;
			var b = new a.event();
	...
	a.event.prototype = {
		output   : function() {
			...
			a.tools.setCss(a.tools.$(".HQ_select_area"),{
				width  : a.cW-1,
				height : a.cH-1,
				top    : top-40,
				left   : lv
	...
	///////////////a.position = function(o,w,h) {}; 
	
	a.cutRun = function() {
		a.resize(a.pic.width,a.pic.height);
